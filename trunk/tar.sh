...
SCRIPTS="cse490h-wgzs/*.sh cse490h-wgzs/*.pl"
SIM_SCRIPTS="cse490h-wgzs/simulator_scripts/Cache* cse490h-wgzs/simulator_scripts/test* cse490h-wgzs/simulator_scripts/*.py"
